...
public class ProductServiceImpl implements IProductService {
    ...
    public ServiceResponse<String> setSaleStatus(Integer productId,Integer status){
        if(productId==null||status==null){
            return ServiceResponse.createByErrorCodeM(ResponseCode.ILLEGAL_ARGUMRNT.getCode(),ResponseCode.ILLEGAL_ARGUMRNT.getDesc());
        }
    ...
    public ServiceResponse<PageInfo> searchProduct(String productName,Integer productId,int pageNem,int pageSize){
        PageHelper.startPage(pageNem,pageSize);
